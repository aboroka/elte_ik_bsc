...
namespace ZH
{
    class Program
    {
        ...
        static void TestDeclare5()
        {
            ...
            Type negyed = typeof(Negyed);
            CheckMethodCorrect(negyed, "DbKatedralis", empty, typeof(int), false, Visibility.Public, negyed, false);
            CheckMethodCorrect(negyed, "OsszIdo", empty, typeof(int), false, Visibility.Public, negyed, false);
            Console.WriteLine();

            Type varos = typeof(Varos);
            CheckMethodCorrect(varos, "MaxOsszIdo", empty, typeof(Negyed), false, Visibility.Public, varos, false);
            CheckMethodCorrect(varos, "KatedralisMindenhol", empty, typeof(bool), false, Visibility.Public, varos, false);
            Console.WriteLine();
        }
        static void TestRun5(Varos v)
        {
            Console.WriteLine($"Varos.MaxOsszIdo: {v.MaxOsszIdo().nev}");
            Console.WriteLine($"Varos.KatedralisMindenhol: {v.KatedralisMindenhol()}");
            Console.WriteLine();
        }
    }
}